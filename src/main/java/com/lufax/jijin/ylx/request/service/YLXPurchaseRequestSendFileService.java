...
@Service
public class YLXPurchaseRequestSendFileService extends YLXSendFileService{
    ...
    public void updateToFail(YLXBatchDTO batch,String msg){
        ...
        if(isFinalFail(batch.getType())) {
            ...
            Logger.warn(this,String.format("YLXPurchaseRequestSendFileService fail batchId:%s",batch.getId()));
    ...
    public void updateToSuccessAndInsertConfirm(YLXBatchDTO batch){
            ...
            confirmBath.setType(YLXBatchType.YLX_SLP_PURCHASE_CONFIRM.name());
    ...
    private void generateConfirmBatchFiles(YLXBatchDTO requestBatch,YLXBatchDTO confirmBatch){
        ...
        for(int i=1;i<=requestFiles.size();i++){
            ...
            String fileName = "prod_purchase_confirm_ljs_op_"+target+"_"+num+".txt";
