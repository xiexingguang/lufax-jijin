...
@Service
public class ProdOprSvcInterfaceService {
    @Autowired
    private ProdOprSvcInterfaceCaller prodOprSvcInterfaceCaller;
    ...
    public ProdOprSvcInterfaceService() {
    }
    ...
    public ListCreateProductResultGson createProduct(ListProductGson listProductGson) {
        ...
        return prodOprSvcInterfaceCaller.post(interfaceCallObject, ListCreateProductResultGson.class);
    }
    ...
    public ListResultGson cancel(ProductDTO product, String productStatusChangeRemark) {
        ...
        return prodOprSvcInterfaceCaller.post(interfaceCallObject, ListResultGson.class);
    }
    ...
    public BaseGson updateJijinStatus(JijinUpdateStatusGson gson){
        ...
        .addFormValue("message", JsonHelper.toJson(gson));
        return prodOprSvcInterfaceCaller.post(interfaceCallObject, BaseGson.class);
    }
    /**
     * 推送人气方案和精选主题
     * @param gsonList
