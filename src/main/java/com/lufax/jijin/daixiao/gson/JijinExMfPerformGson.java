...
public class JijinExMfPerformGson {
    ...
    public JijinExMfPerformGson(JijinExMfPerformDTO jijinExMfPerfomDTO) {
        this.fundCode = jijinExMfPerfomDTO.getFundCode();
        this.performanceDay = jijinExMfPerfomDTO.getPerformanceDay();
        this.benefitDaily = jijinExMfPerfomDTO.getBenefitDaily();
        this.benefitOneWeek = jijinExMfPerfomDTO.getBenefitOneWeek();
        this.benefitOneMonth = jijinExMfPerfomDTO.getBenefitOneMonth();
        this.benefitThreeMonth = jijinExMfPerfomDTO.getBenefitThreeMonth();
        this.benefitSixMonth = jijinExMfPerfomDTO.getBenefitSixMonth();
        this.benefitOneYear = jijinExMfPerfomDTO.getBenefitOneYear();
        this.benefitTwoYear = jijinExMfPerfomDTO.getBenefitTwoYear();
        this.benefitThreeYear = jijinExMfPerfomDTO.getBenefitThreeYear();
        this.benefitThisYear = jijinExMfPerfomDTO.getBenefitThisYear();
        this.benefitTotal = jijinExMfPerfomDTO.getBenefitTotal();
        this.kinBenefitOneWeek = jijinExMfPerfomDTO.getKinBenefitOneWeek();
        this.kinBenefitOneMonth = jijinExMfPerfomDTO.getKinBenefitOneMonth();
        this.kinBenefitThreeMonth = jijinExMfPerfomDTO.getKinBenefitThreeMonth();
        this.kinBenefitSixMonth = jijinExMfPerfomDTO.getKinBenefitSixMonth();
        this.kinBenefitOneYear = jijinExMfPerfomDTO.getKinBenefitOneYear();
        this.kinBenefitTwoYear = jijinExMfPerfomDTO.getKinBenefitTwoYear();
        this.kinBenefitThreeYear = jijinExMfPerfomDTO.getKinBenefitThreeYear();
        this.kinBenefitThisYear = jijinExMfPerfomDTO.getKinBenefitThisYear();
        this.kinBenefitTotal = jijinExMfPerfomDTO.getKinBenefitTotal();
        this.orderOneWeek = jijinExMfPerfomDTO.getOrderOneWeek();
        this.orderOneMonth = jijinExMfPerfomDTO.getOrderOneMonth();
        this.orderThreeMonth = jijinExMfPerfomDTO.getOrderThreeMonth();
        this.orderSixMonth = jijinExMfPerfomDTO.getOrderSixMonth();
        this.orderOneYear = jijinExMfPerfomDTO.getOrderOneYear();
        this.orderTwoYear = jijinExMfPerfomDTO.getOrderTwoYear();
        this.orderThreeYear = jijinExMfPerfomDTO.getOrderThreeYear();
        this.orderThisYear = jijinExMfPerfomDTO.getOrderThisYear();
        this.orderTotal = jijinExMfPerfomDTO.getOrderTotal();
    }
