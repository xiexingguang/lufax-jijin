...
public class JijinExFxPerformServiceTest extends AbstractTransactionalJUnit4SpringContextTests{
	...
	public void testRecordFileSync(){
	    ...
	    jijinSyncFileDTO.setFileName("/home/chenqunhui/Documents/wind_20150729230000_14.txt");
	    jijinSyncFileDTO.setCurrentLine(1l);
	    try {
	    	jijinExFxPerformService.recordFileSync(jijinSyncFileDTO);
		} catch (IOException e) {
	...
	public void testHandle(){
		List<JijinExFxPerformDTO> list = jijinExFxPerformRepository.getUnDispachedJijinExFxPerform(20);
		for(JijinExFxPerformDTO  dto :list){
